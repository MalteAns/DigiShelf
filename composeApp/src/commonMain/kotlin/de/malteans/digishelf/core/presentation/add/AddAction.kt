...
sealed class AddAction {
    ...
    data class OnTensionLevelChanged(val level: Int): AddAction()
    data class OnSpiceLevelChanged(val level: Int): AddAction()
    data class OnEmotionLevelChanged(val level: Int): AddAction()
    data class OnChapterLengthChanged(val level: Int): AddAction()
    data class OnEndingRatingChanged(val level: Int): AddAction()
    data class OnPlotRatingChanged(val level: Int): AddAction()
